...
$response = ['status' => 0, 'message' => " Password Secret Vaults Retrieval  Failed. Try Again.  Error: $summary "];
echo json_encode($response);
...
$response = ['status' => 1, 'message' => " Password Secret Vaults Retrieval Successful", 'secret' => $secret];
echo json_encode($response);
